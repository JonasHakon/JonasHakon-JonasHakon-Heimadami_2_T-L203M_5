...
var index = [];                // N�mer n�verandi punkts
...
window.onload = function init() {
    ...
    canvas.addEventListener("mousedown", function(e){
        ...
        var t = [2*e.offsetX/canvas.width-51, 2*(canvas.height-e.offsetY)/canvas.height-1, 2*e.offsetX/canvas.width+49, 2*(canvas.height-e.offsetY)/canvas.height-1, 2*e.offsetX/canvas.width-1, 2*(canvas.height-e.offsetY)/canvas.height+49];
        
        // F�ra �essi hnit yfir � graf�kminni, � r�ttan sta�
        gl.bufferSubData(gl.ARRAY_BUFFER, 24*index, t);
